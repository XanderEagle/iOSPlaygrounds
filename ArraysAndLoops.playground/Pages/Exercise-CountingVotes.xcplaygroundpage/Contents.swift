...
for shouldMascotChangeVotes in {
    
}
for shouldInstallCoffeeVendingMachineVotes in {
    
}

for shouldHaveMorePollOptionsVotes in {
...
printResults(forIssue: "Should we install codde vending machines?", withVotes:shouldInstallCoffeeVendingMachineVotes)

printresults(forIssue: "Should we have more poll options?", with:shouldHaveMorePollOptionsVotes)
