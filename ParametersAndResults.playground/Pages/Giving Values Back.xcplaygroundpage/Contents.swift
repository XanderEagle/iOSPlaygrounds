...
favorite(categoryOfThing: "salad", favorite: "garden")
...
favorite(categoryOfThing: "movie", favorite: "Cast Away")
...
func helloFavorite(favoriteFood: String, favoriteVideoStar: String)-> String {
    return "my favorite \(favoriteFood) is \(favoriteVideoStar)"
}

helloFavorite(favoriteFood: "Fajitas", favoriteVideoStar: "Cody Ko")
